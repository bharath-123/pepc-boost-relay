...
var Migration010AddTobRobExecutionPayloads = &migrate.Migration{
	...
	Up: []string{`
		...
		CREATE INDEX IF NOT EXISTS ` + vars.TableTobBuilderBlockSubmission + `_mostprofit_idx ON ` + vars.TableTobBuilderBlockSubmission + `("was_most_profitable");
		...
		CREATE INDEX IF NOT EXISTS ` + vars.TableRobBuilderBlockSubmission + `_mostprofit_idx ON ` + vars.TableRobBuilderBlockSubmission + `("was_most_profitable");
