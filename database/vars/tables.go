...
var (
	...
	TableTobExecutionPayload       = tableBase + "_tob_execution_payload"
	TableRobExecutionPayload       = tableBase + "_rob_execution_payload"
	TableExecutionPayload          = tableBase + "_execution_payload"
	TableBuilderBlockSubmission    = tableBase + "_builder_block_submission"
	TableTobBuilderBlockSubmission = tableBase + "_tob_builder_block_submission"
	TableRobBuilderBlockSubmission = tableBase + "_rob_builder_block_submission"
